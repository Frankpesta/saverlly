...
@Module({
  imports: [BullModule.registerQueue({ name: QUEUE_NAMES.GENERATE_PAYOUTS }), StripeModule],
  controllers: [StripeWebhooksController, PayoutsController, MyPayoutsController],
  providers: [PayoutsService, GeneratePayoutsProcessor, PayoutGenerationSchedulerService],
