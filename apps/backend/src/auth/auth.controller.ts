...
export class AuthController {
  ...
  @ApiOperation({ summary: 'Log in with email + password, get an access/refresh token pair' })
  ...
  @ApiResponse({ status: 200, description: 'A fresh token pair; the old refresh token is now invalid' })
