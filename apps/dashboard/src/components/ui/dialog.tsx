  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 max-h-[calc(100svh-2rem)] w-[calc(100%-1.5rem)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl bg-popover bg-clip-padding text-sm text-popover-foreground shadow-lg ring-1 ring-border [scrollbar-width:none] [&::-webkit-scrollbar]:hidden duration-200 outline-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-open:slide-in-from-bottom-2 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 sm:max-w-2xl [&>form]:overflow-visible",
          className,
        )}
        {...props}
      >
