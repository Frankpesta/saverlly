...
/**
 * Rather than a decorative glyph in a circle, the empty state shows the actual surface a
 * promotion occupies — the extension popup, with the sponsored slot called out and empty. A
 * first-time admin's real question here is "what is this and where does it show up?", and the
 * product's own UI answers that better than an illustration can.
 */
export function PromotionsEmptyState() {
  return (
    <div className="overflow-hidden rounded-2xl border border-black/8 bg-gradient-to-b from-muted/40 to-transparent dark:border-white/10">
      <div className="grid grid-cols-1 items-center gap-10 px-6 py-12 md:grid-cols-[auto_minmax(0,1fr)] md:px-12">
        ...
        <div className="mx-auto w-fit md:mx-0">
          <div className="rotate-[-3deg] rounded-[10px] shadow-[0_18px_40px_-16px_rgba(17,27,24,0.28)] transition-transform duration-300 hover:rotate-0">
        ...
        <div className="flex flex-col items-start gap-5">
          <div>
            ...
            <p className="mt-1.5 max-w-md text-sm text-muted-foreground">
              ...
              while a shopper is browsing a store — in the highlighted slot on the left.
            </p>
          </div>
