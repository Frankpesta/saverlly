        ...
        {!result ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Creates an admin-level teammate with full access to this console. We&apos;ll
                generate a secure password for them.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            ...
            <div className="flex flex-col gap-4 px-6">
              ...
              <p className="text-sm text-muted-foreground">
                This password won&apos;t be shown again — share it securely. They&apos;ll be asked
                to set a new one the first time they log in.
              </p>
            </div>
